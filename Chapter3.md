...
![インストール先画面](image/Ch3/installDisk.png){width=70%}
...
![NATネットワークのインターフェース画面](image/Ch3/installNetNAT.png){width=70%}
...
![ホストオンリーネットワークのインターフェース画面](image/Ch3/installNetHostOnly.png){width=70%}
...
![ソフトウェアの選択画面](image/Ch3/selectSoftware.png){width=70%}
