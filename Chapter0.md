...
今回私は、第2章から第4章の実習部分を担当させてもらいました。このようなプロジェクトに関わるのは初めてで、大変良い経験となりました。
本教科書がこれからLinuxを学ばれる多くの皆様の助けになれば幸いです。

### バージョン4の開発にご協力をいただいた方々 {.unlisted .unnumbered}
- 畑屋 歩
- 鯨井 貴博
...
フィードバックは誰でも参加できるSlackで行われていますので、積極的にご参加ください。詳細は以下の本教科書のWebページを参照してください。
